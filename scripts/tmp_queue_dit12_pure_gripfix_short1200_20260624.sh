...
QUEUE_LOG=train_logs/queue_dit12_pure_gripfix_short1200_20260624.log
TRAIN_LOG=train_logs/dit12_pure_gripfix_short1200_20260624.log
...
RUN_ID=configs+libero_object_no_noops+b16+lr-0.0002+lora-r32+dropout-0.0--image_aug--VLA-Adapter-DIT12-fullaction-pure-gripfix-short1200-20260624
...
echo "[queue] short conservative pure DIT training from 1000 to 1200" >> "$QUEUE_LOG"
...
/home/xiaguanxiao/miniconda3/envs/vla-flow/bin/torchrun --standalone --nnodes 1 --nproc-per-node 1 \
  ...
  --run_id_note VLA-Adapter-DIT12-fullaction-pure-gripfix-short1200-20260624 \
