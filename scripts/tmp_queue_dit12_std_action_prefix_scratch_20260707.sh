...
LABEL=dit12_h896_std_action_prefix_scratch_b4ga4_12000_20260707
RUN_ID=DIT12-h896-std-action-prefix-scratch-b4ga4-12000-20260707
...
wait_gpu(){
  while true; do
    ...
    if [ "$free" -gt 70000 ] && [ "$util" -lt 20 ] && [ "$jobs" -eq 0 ]; then break; fi
    sleep 60
  done
}
