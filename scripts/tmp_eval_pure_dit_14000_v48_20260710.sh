...
LABEL=dit12_h896_std_action_prefix_scratch_continue12000to20000_v48_lr1e4_20260710_step14000_hard_eval
CHKPT=outputs/configs+libero_object_no_noops+b8+lr-0.0001+lora-r32+dropout-0.0--image_aug--DIT12-h896-std-action-prefix-scratch-continue12000to20000-v48-lr1e4-20260710--14000_chkpt
LOG=train_logs/${LABEL}.log
...
grep -n 'Final results\|Total episodes\|Total successes\|Overall success rate\|Current task success rate\|Current total success\|Success:' "$LOG" | tail -120
