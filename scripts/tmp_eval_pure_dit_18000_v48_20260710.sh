...
CHKPT=outputs/configs+libero_object_no_noops+b8+lr-0.0001+lora-r32+dropout-0.0--image_aug--DIT12-h896-std-action-prefix-scratch-continue12000to20000-v48-lr1e4-20260710--18000_chkpt
LOG=train_logs/dit12_h896_std_action_prefix_scratch_continue12000to20000_v48_lr1e4_20260710_step18000_hard_eval.log
