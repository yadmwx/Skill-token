...
QUEUE_LOG=train_logs/queue_dit12_fullaction_adaptive_20260623.log
TRAIN_LOG=train_logs/dit12_fullaction_adaptive_20260623.log
...
echo "[queue] launching DIT12 full-action adaptive training" >> "$QUEUE_LOG"
...
echo "[queue] training finished, starting eval adaptive full-action" >> "$QUEUE_LOG"
./eval.sh "$CHKPT_DIR" \
