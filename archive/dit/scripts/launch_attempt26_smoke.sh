...
RUN=/root/autodl-tmp/depthcurriculum_seed9_20260816_attempt26_multidepthdit_smoke
...
/root/miniconda3/bin/torchrun --standalone --nnodes=1 --nproc-per-node=1 vla-scripts/finetune.py \
  ...
  --use_film False \
  --seed 9 \
  --run_id_override DIT-pureflow-canonical-a26-multidepth-smoke \
  --run_id_note a26-multidepth-smoke \
