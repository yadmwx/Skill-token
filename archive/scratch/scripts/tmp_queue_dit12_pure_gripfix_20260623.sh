...
QUEUE_LOG=train_logs/queue_dit12_pure_gripfix_20260623.log
TRAIN_LOG=train_logs/dit12_pure_gripfix_20260623.log
...
echo "[queue] launching pure DIT12 full-action training with gripper-weighted flow loss" >> "$QUEUE_LOG"
...
echo "[queue] training finished, starting pure eval" >> "$QUEUE_LOG"
./eval.sh "$CHKPT_DIR" \
