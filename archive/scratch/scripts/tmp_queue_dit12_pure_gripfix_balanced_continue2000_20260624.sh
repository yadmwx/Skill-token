...
QUEUE_LOG=train_logs/queue_dit12_pure_gripfix_balanced_continue2000_20260624.log
TRAIN_LOG=train_logs/dit12_pure_gripfix_balanced_continue2000_20260624.log
...
RUN_ID=configs+libero_object_no_noops+b16+lr-0.0002+lora-r32+dropout-0.0--image_aug--VLA-Adapter-DIT12-fullaction-pure-gripfix-balanced-20260624
FINAL_CHKPT="outputs/${RUN_ID}--2000_chkpt"
...
echo "[queue] resuming pure DIT12 balanced full-action training from 1000 to 2000" >> "$QUEUE_LOG"
...
/home/xiaguanxiao/miniconda3/envs/vla-flow/bin/torchrun --standalone --nnodes 1 --nproc-per-node 1 \
  ...
  --run_id_note VLA-Adapter-DIT12-fullaction-pure-gripfix-balanced-20260624 \
...
echo "[queue] balanced training finished, starting pure eval at default gripper threshold" >> "$QUEUE_LOG"
./eval.sh "$FINAL_CHKPT" \
