...
ROOT=/autodl-fs/data/skill_depth
...
LABEL=dit12_h896_std_action_prefix_pure_frommlp5000_b4ga4_16000_v48_20260704
RUN_ID=DIT12-h896-std-action-prefix-pure-frommlp5000-b4ga4-16000-v48-20260704
...
if [ -f "$STATUS" ] && [ "$(cat "$STATUS")" = 0 ]; then
  ...
  "$TORCHRUN" --standalone --nnodes 1 --nproc_per_node 1 \
    ...
    --data_root_dir ${ROOT}/data/libero \
