...
export PYTHONPATH=.:/home/xiaguanxiao/code/VLA/LIBERO:/home/xiaguanxiao/code/VLA/LIBERO/libero:/home/xiaguanxiao/code/starVLA/robosuite:${PYTHONPATH:-}
export PYOPENGL_PLATFORM=osmesa
export MUJOCO_GL=osmesa
export TOKENIZERS_PARALLELISM=false
export WANDB_MODE=offline

LABEL=dit12_h896_std_action_prefix_pure_frommlp5000_resume5000to10000_a100_b8ga2_20260709
RUN_ID=DIT12-h896-std-action-prefix-pure-frommlp5000-resume5000to10000-a100-b8ga2-20260709
...
wait_gpu(){
  while true; do
    ...
    if [ "$free" -gt 70000 ] && [ "$util" -lt 40 ] && [ "$jobs" -eq 0 ]; then break; fi
    sleep 60
  done
}
...
if [ -f "$STATUS" ] && [ "$(cat "$STATUS")" = 0 ]; then
  ...
  : > "$TRAIN_LOG"
  : > "$STATUS"
  log "launch MLP5000 -> DIT5000 train label=$LABEL"
  wait_gpu
  set +e
