...
function Invoke-RemotePython {
    ...
    ssh xiaguanxiao@100.106.143.20 "bash -lc 'source ~/miniconda3/etc/profile.d/conda.sh && conda activate vla-flow && cd $repo && python -c \"import base64; exec(base64.b64decode(\\\"$encoded\\\").decode(\\\"utf-8\\\"))\"'"
}
